...
class CoppeliaControl:
    ...
    def _calculate_velocity_and_time(self, old_position: float, new_position: float, velocity: float, time_complete: float):
        ...
        return velocity_with_sign, abs((new_position - old_position) * time_complete / 360)
    ...
    def _move_arm(self, new_position):
        ...
        velocity, time_sleep = self._calculate_velocity_and_time(self.position_arm, new_position, self.ARM_VELOCITY, self.TIME_TO_COMPLETE_ARM)
    ...
    def _move_crab(self, new_position):
        ...
        crane_simulation = self.crane_simulation
        velocity, time_sleep = self._calculate_velocity_and_time(self.position_crab, new_position, self.CRAB_VELOCITY, self.TIME_TO_COMPLETE_CRAB)
